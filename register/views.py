...
from .forms import (
    LoginForm, UserCreateForm, UserCompleteCreateFormNester, UserCompleteCreateFormPartner, UserUpdateForm, MyPasswordChangeForm,
...
class UserCreate(generic.CreateView):
    """ユーザー仮登録"""
    template_name = 'register/user_create_NorP.html'
    form_class = UserCreateForm

class UserCreateNester(generic.CreateView):
    """ユーザー仮登録"""
...
class UserCreatePartner(generic.CreateView):
    """ユーザー仮登録"""
    template_name = 'register/user_create.html'
    form_class = UserCreateForm
...
class UserCreateCompleteForm(generic.CreateView):
    """ユーザー本登録"""
    template_name = 'register/user_create.html'
    form_class = UserCreateForm
    def form_valid(self, form):
        ...
        return redirect('user_create_complete')
        ...
        # tokenは問題なし
            ...
            try:
                ...
                if not user.is_active:
                    # UserCreateCompleteForm.as_view()
                    ...
                    # return redirect('user_create_complete_toForm')
                    # return resolve_url('register:user_create_complete_toForm', pk=user_pk)
