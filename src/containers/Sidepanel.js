...
class Sidepanel extends React.Component {
  ...
  render() {
    console.log(this.props.chats.participants);
    const chatroom = this.props.chats;
    // .filter(
    //   value => value !== this.props.username
    // );
    console.log("sidepanel-chatchat");
    ...
    let activeChats = this.props.chats.map(c => {
      ...
      console.log(partner);
      console.log(c.participants.includes(this.props.username));
      if (c.participants.includes(this.props.username)) {
        return (
          <Contact
            key={c.id}
            // name="Harveyふぁ"
